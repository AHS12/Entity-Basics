...
namespace DBfirst
{
    ...
    public partial class PlutoDbContex : DbContext
    {
        public PlutoDbContex()
            : base("name=PlutoDbContex")
        {
        }
        ...
        [DbFunction("PlutoDbContex", "GetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> GetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[PlutoDbContex].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
